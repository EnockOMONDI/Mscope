...
from core.views import (
    ...
    services_mice_view,
    services_corporate_travel_view,
    services_solution_detail_view,
...
urlpatterns = [
    ...
    path('services/corporate-travel/', services_corporate_travel_view, name='services_corporate_travel'),
    path('services/technology-tools/', services_solution_detail_view, {"solution_key": "technology_tools"}, name='services_technology_tools'),
    path('services/risk-management-duty-of-care/', services_solution_detail_view, {"solution_key": "duty_of_care"}, name='services_duty_of_care'),
    path('services/travel-analytics-reporting/', services_solution_detail_view, {"solution_key": "analytics_reporting"}, name='services_analytics_reporting'),
    path('services/strategic-travel-management/', services_solution_detail_view, {"solution_key": "strategic_management"}, name='services_strategic_management'),
